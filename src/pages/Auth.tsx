...
const Auth = () => {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: "Welcome to Festivus! You can now create and join events.",
    });
          ...
          <TabsContent value="register">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Join Festivus and start organizing amazing events
                </CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleRegister} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="register-confirm" className="flex items-center space-x-2">
                      <Lock className="h-4 w-4" />
