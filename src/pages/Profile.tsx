                    ...
                    <DialogContent>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex justify-end space-x-2">
                          ...
                          <Button onClick={handleSaveProfile} className="btn-gradient-primary">
                            Save Changes
                          </Button>
                        </div>
                      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <h3 className="text-2xl font-bold text-primary">{organizedEvents.length}</h3>
          ...
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <h3 className="text-2xl font-bold text-accent">{attendedEvents.length}</h3>
          ...
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <h3 className="text-2xl font-bold text-secondary">
                {organizedEvents.reduce((sum, event) => sum + event.rsvpCount, 0)}
              </h3>
