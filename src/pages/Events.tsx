	...
	const mockEvents = [
		{
			...
			description:
				"Join us for an unforgettable night of live music featuring local and international artists.",
		...
		},
		{
			...
			description:
				"Taste amazing food from the best food trucks in the city. Family-friendly event with live entertainment.",
		...
		},
		{
			...
			description:
				"Learn from industry leaders about the latest trends in technology and innovation.",
		...
		},
		{
			...
			description:
				"Help make our neighborhood beautiful! Join fellow residents for a community clean-up initiative.",
		...
		},
		{
			...
			description:
				"Discover amazing works by local artists at our newest gallery exhibition opening.",
		...
		<div className="container py-8">
			...
			<div className="text-center mb-8">
				...
				<p className="text-muted-foreground text-lg max-w-2xl mx-auto">
					Find amazing events happening in your community. From music festivals
